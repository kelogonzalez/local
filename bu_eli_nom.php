...
if(isset($_POST['enviar']))	//Aqui el codigo PHP Y REVISAMOS SI NO "PINCHARON EL BOTON DE BUSCAR DEL FORMULARIO QUE ESTA MAS ABAJO DEL CODIGO"
 {
 	...
 	$nombres=$_POST['nombres'];//Sacamos de la variable POST y lo almacenamos en la veriable $tit
$buscar=mysql_query("SELECT * FROM registro WHERE nombres LIKE '%$nombres%'"); //Busqueda por medio de la Titulo(CONSULTA MYSQL)
...
<div id="tabla_pres"> <!--INICIAMOS EN HTML UNA TABLA PARA POSTEAR LOS RESULTADOS DE LA CONSULTA(busqueda)-->
 <table align="center">
<tr bgcolor="#1882ad" align="center"><td><font color="white">ID</font></td><td><font color="white">Cédula</font></td><td><font color="white">Nombres</font></td><td><font color="white">Principal</font></td><td><font color="white">Secundaria</font></td><td><font color="white">Razón Social</font></td></tr>
<?php
