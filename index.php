...
<title>Censo Locales Comerciales</title>
...
if (isset($_SESSION['Administrador'])){ //CHECAMOS SI NO SE INICIO INICIO SESION ANTERIORMENTE PARA MOSTRAR EL MENU DE ADMINISTRACION
   ...
   <!-- <li><a href="usuario.php">Usuarios</a></li>-->
	...
	<li><a href="export.php">Reporte</a>
	 ...
	 <div id="texto">
Censo de Locales Comerciales del cantón Naranjal.</div>
</form>
<div id="formcontact">
</div>
	 <?php } else {?>	
...
<div id="texto">
Censo de Locales Comerciales del cantón Naranjal.
